export default [
  {
    ...
    image: "/public/images/maze.avif",
    tags: ["Unity 3D", "C#", "Computer Architecture"],
    github: "https://github.com/KahnishgaSolaidurairaj/Maze.exe",
    // demo: null
  },
  {
    title: "Survive If You Can",
    description: "An interactive narrative-driven horror game, where the player navigates a haunted house, making choices that affect the story and determine the ending.",
    image: "/public/images/horror.avif",
    tags: ["React", "Git", "Aedify.Ai"],
    github: "https://github.com/KahnishgaSolaidurairaj/SurviveIfYouCan",
    demo: "https://surviveifyoucan-b816ef68.aedify.ai"
  },
  {
    title: "Pastry Pop",
    description: "A fun Unity 3D arcade-style game where the player throw purple frisbee's to hit the desserts (bunny pastries) and score points. Additionally the player is surrounded by a physics based forcefield displayed as mountains.",
    image: "/public/images/pastry.avif",
  ...
  },
  {
    ...
    description: "A Digital Scrapbook of my experiances through winter break highlighting the small sweet moments through the weeks of winter break 2025-2026",
    image: "/public/images/journal.avif",
  ...
  },
  {
    ...
    image: "/public/images/rover.avif",
    tags: ["Arduino", "I2C Communication", "Ambedded Systems"],
    github: "https://github.com/KahnishgaSolaidurairaj/Rescue-Rover",
    demo: "https://www.youtube.com/watch?v=FQ8M7CXJ4NI"
  },
  {
    title: "3 Card Poker",
    ...
    image: "/public/images/poker.avif",
    tags: ["Java Sockets", "Client-Server", "CSS", "HTML"]
  },
  {
    ...
    image: "/public/images/typing.avif",
    tags: ["JavaScript", "CSS", "HTML"],
    github: "https://github.com/KahnishgaSolaidurairaj/Typing-Showdown",
    demo: "https://www.youtube.com/watch?v=IIoVs027G4E&feature=youtu.be"
  }
];